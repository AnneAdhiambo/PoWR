...
const projects = [
  {
    catalogName: "bitcoin/bitcoin",
    project: "bitcoin/bitcoin",
    description: "Bitcoin Core's integration and staging tree for the Bitcoin peer-to-peer network.",
    url: "https://github.com/bitcoin/bitcoin",
    language: "C++",
    stars: 89849,
    issues: 699,
    points: "100–300",
    avatar: "https://avatars.githubusercontent.com/u/528860?v=4",
  },
  {
    catalogName: "stacks-network/stacks-core",
    project: "stacks-network/stacks-core",
    description: "The Rust implementation of the Stacks blockchain and its Bitcoin settlement layer.",
    url: "https://github.com/stacks-network/stacks-core",
    language: "Rust",
    stars: 3061,
    issues: 672,
    points: "90–260",
    avatar: "https://avatars.githubusercontent.com/u/8165984?v=4",
  },
  {
    catalogName: "ethereum/go-ethereum",
    project: "ethereum/go-ethereum",
    description: "The Go implementation of the Ethereum protocol, commonly known as Geth.",
    url: "https://github.com/ethereum/go-ethereum",
    language: "Go",
    stars: 51281,
    issues: 415,
    points: "100–280",
    avatar: "https://avatars.githubusercontent.com/u/6250754?v=4",
  },
  {
    catalogName: "rust-bitcoin/rust-bitcoin",
    project: "rust-bitcoin/rust-bitcoin",
    description: "Foundational Bitcoin data structures and network primitives for Rust applications.",
    url: "https://github.com/rust-bitcoin/rust-bitcoin",
    language: "Rust",
    stars: 2654,
    issues: 484,
    points: "70–220",
    avatar: "https://avatars.githubusercontent.com/u/37084147?v=4",
  },
  {
