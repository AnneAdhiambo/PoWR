...
export default function DevelopersPage() {
  return <ContentPage eyebrow="For developers" title="Let the work speak before the resume does." description="PoWR helps developers turn real contributions into a portable, inspectable reputation while retaining control over discovery, contact, evidence sharing, applications, and referrals." cta="Build your profile" features={[
